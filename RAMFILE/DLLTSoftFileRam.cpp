...
#pragma link "DLLTSoftDlaChara.obj"
//---------------------------------------------------------------------------
//DATABASE
//---------------------------------------------------------------------------

__stdcall TSoftFileRam::TSoftFileRam(void)
{
...
__stdcall TSoftFileRam::TSoftFileRam(char *AName)
{
...
void __stdcall TSoftFileRam::SetName(char *AName)
{
maciez.FName = strReDup(maciez.FName,AName);
}
//---------------------------------------------------------------------------

bool __stdcall TSoftFileRam::Open()
{
...
maciez.FHMap = CreateFileMapping(maciez.FHand,NULL,
                                 ...
                                 0,maciez.FRealSize, "TSoftFileMem");
...
void __stdcall TSoftFileRam::Close()
{
if (this->Base!=NULL)
...
long __stdcall TSoftFileRam::Resize(long ASize)
{
...
void *__stdcall TSoftFileRam::Alloc(long Aptr_size)
{
...
void *__stdcall TSoftFileRam::ReAlloc(void *ptr, long Aptr_size)
{
__node *bgn = (__node*)this->Base;
...
void __stdcall TSoftFileRam::Free(void *ptr)
{
__node *bgn = (__node*)this->Base;
__node *cur = (__node*)((ULONG)ptr - sizeof(__node));
__node *dad = (__node*)((ULONG)bgn + cur->prev);
...
void __stdcall TSoftFileRam::Defrag()
{
__node *bgn = (__node*)this->Base;
...
void __stdcall TSoftFileRam::Flush(void *ptr, long size)
{
