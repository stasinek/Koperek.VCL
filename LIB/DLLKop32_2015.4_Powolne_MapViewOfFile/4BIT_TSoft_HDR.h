...
extern "C" {
//---------------------------------------------------------------------------
__declspec(dllexport) unsigned char __stdcall   Code_bitLength(DWORD *alpcode,char alpcode_bit,DWORD axdata_uncoded);
__declspec(dllexport) unsigned char __stdcall DeCode_bitLength(DWORD *alpdata_uncoded,DWORD *axcode,char axcode_bit);
__declspec(dllexport) unsigned char __stdcall  Price_bitLength(DWORD   axdata_uncoded);
__declspec(dllexport) unsigned char __stdcall   Code_bitOffset(DWORD *alpcode,char alpcode_bit,DWORD axdata_uncoded);
__declspec(dllexport) unsigned char __stdcall DeCode_bitOffset(DWORD *alpdata_uncoded,DWORD *axcode,char axcode_bit);
__declspec(dllexport) unsigned char __stdcall  Price_bitOffset(DWORD   axdata_uncoded);
__declspec(dllexport) unsigned char __stdcall   Code_bitString(DWORD *alpcode,char alpcode_bit,DWORD axdata_uncoded);
__declspec(dllexport) unsigned char __stdcall DeCode_bitString(DWORD *alpdata_uncoded,DWORD *axcode,char axcode_bit);
__declspec(dllexport) unsigned char __stdcall  Price_bitString(DWORD   axdata_uncoded);

__declspec(dllexport) unsigned char __stdcall   Code_bitHeader(DWORD *alpcode,char alpcode_bit,char axdata_uncoded);
__declspec(dllexport) unsigned char __stdcall DeCode_bitHeader(char  *alpdata_uncoded,DWORD *axcode,char axcode_bit);
__declspec(dllexport) unsigned char __stdcall  Price_bitHeader(char   axdata_uncoded);
